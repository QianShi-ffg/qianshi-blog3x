...
const filteredDiaries = () => {
  ...
  return diaries.value.filter(diary => diary.type === currentFilter.value);
};

const playVideo = (diary) => {
  diary.showVideo = true;
};
</script>
        ...
        <div class="header-content">
          ...
          <nav class="nav">
            <ul>
              ...
              <li><a href="#" class="nav-link active" @click.prevent="navigateTo('diary')">日记</a></li>
      ...
      <div class="container">
        ...
        <section class="diary-section">
          <div class="diary-grid">
            ...
            >
              <!-- 图片类型 -->
              <template v-if="diary.type === 'image'">
                <div class="diary-images">
                  <div class="images-grid" :class="diary.images.length">
                    <div
                      v-for="(img, index) in diary.images"
                      :key="index"
                      class="image-item"
                    >
                      <img :src="img" :alt="diary.title" loading="lazy" />
                    </div>
                  </div>
                </div>
              ...
              <!-- 视频类型 -->
              <template v-else-if="diary.type === 'video'">
                <div class="diary-video">
                  <div class="video-thumbnail" @click="playVideo(diary)">
                    <img :src="diary.thumbnail" :alt="diary.title" />
                  ...
                  <div v-if="diary.showVideo" class="video-player">
                    <video controls autoplay>
                      <source :src="diary.videoUrl" type="video/mp4" />
                      您的浏览器不支持视频播放
                    </video>
                    <button class="close-video" @click="diary.showVideo = false">×</button>
                  </div>
                </div>
                <div class="diary-content">
                  <div class="diary-meta">
        ...
        <div class="footer-content">
          ...
          <div class="footer-links">
            ...
            <ul>
              ...
              <li><a href="#" @click.prevent="navigateTo('diary')">日记</a></li>
...
.diary-card:hover .image-item img {
