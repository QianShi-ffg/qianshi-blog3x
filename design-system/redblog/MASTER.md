...
| Secondary | `#FFE4E6` | `--color-secondary` |
| CTA/Accent | `#BE123C` | `--color-cta` |
| Background | `#FAFAFA` | `--color-background` |
| Text | `#0F172A` | `--color-text` |

**Color Notes:** Fresh Red (Rose) accent with minimalist light background and dark slate text.
